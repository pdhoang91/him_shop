defmodule KafiWealthWeb.ImageLive do
  ...
  def render(assigns) do
    ...
    <div style={"margin-left: #{@depth * 50}px;"}>
      ...
      <br/>
      <img phx-click="boom"
        src={Routes.static_path(KafiWealthWeb.Endpoint, "/images/phoenix.png")}
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, width: 300, bg: "white", depth: 0, max_depth: 0)}
  end
