defmodule KafiWealthWeb.PostLive.PostComponent do
  use KafiWealthWeb, :live_component
  ...
  def handle_event("like", _, socket) do
    KafiWealth.Timeline.inc_likes(socket.assigns.post)
    {:noreply, socket}
  end

  def handle_event("repost", _, socket) do
    KafiWealth.Timeline.inc_reposts(socket.assigns.post)
    {:noreply, socket}
  end
end
