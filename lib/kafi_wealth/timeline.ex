defmodule KafiWealth.Timeline do
  @moduledoc """
  ...
  alias KafiWealth.Timeline.Post
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(KafiWealth.PubSub, "posts")
  end

  defp broadcast({:error, _reason} = error, _event), do: error

  defp broadcast({:ok, post}, event) do
    Phoenix.PubSub.broadcast(KafiWealth.PubSub, "posts", {event, post})
    {:ok, post}
  end
